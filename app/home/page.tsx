...
<path d="M8.375 0.274963L5 3.64996L1.625 0.274963L0.5 1.39996L5 5.89996L9.5 1.39996L8.375 0.274963Z" fill="#0E0E0F"/>
</svg>
        </button>
        <button className="bg-white text-white bg-opacity-5 rounded-full py-3 px-4 text-sm flex items-center gap-1 shrink-0">
          ...
          <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.375 0.274963L5 3.64996L1.625 0.274963L0.5 1.39996L5 5.89996L9.5 1.39996L8.375 0.274963Z" fill="white"/>
</svg>
        </button>
        <button className="bg-white text-white bg-opacity-5 rounded-full py-3 px-4 text-sm flex items-center gap-1 shrink-0">
        ...
        >
          {news.map((film, index) => (
            <SplideSlide key={index}>
              <Image width={310} height={240} src={film.image} alt="image" />
            </SplideSlide>
          ))}
        </Splide>
      </div>
